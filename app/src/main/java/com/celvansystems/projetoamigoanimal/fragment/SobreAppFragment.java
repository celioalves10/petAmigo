...
public class SobreAppFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_sobreapp, container, false);
    ...
    private void configurarAcoes() {
        ...
        constAvaliarApp.setOnClickListener(v -> {
            try {
        ...
        constCompartilharApp.setOnClickListener(v -> {
            try {
        ...
        constEnviarFeedBack.setOnClickListener(v -> {
            try {
        ...
        constErro.setOnClickListener(v -> {
            try {
        ...
        imvFacebook.setOnClickListener(v -> {
            try {
        ...
        imvInstagram.setOnClickListener(v -> {
            try {
